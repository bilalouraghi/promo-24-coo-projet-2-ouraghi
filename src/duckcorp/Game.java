...
public class Game {
    ...
    /**
     * Crée une instance de machine selon le choix du joueur.
     *
     * @param choice le choix de machine (1 : StandardPress, 2 : MiniPress, 3 : LuxuryMold)
     * @return une nouvelle instance de Machine correspondant au choix
    ...
    private Machine createMachine(int choice) {
        switch (choice) {
            ...
            default: throw new IllegalArgumentException("Choix de machine invalide : " + choice);
        }
    }
}
